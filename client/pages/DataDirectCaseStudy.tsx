      ...
      <div className="max-w-[1920px] mx-auto px-4 sm:px-8 lg:px-[100px] pt-16 pb-24 animate-in fade-in-0 slide-in-from-bottom-8 duration-1000 delay-500">
        <div className="mb-8">
          ...
          <h1 className="text-4xl sm:text-6xl lg:text-[72px] font-medium text-[#131417] leading-[120%] tracking-[-1.44px] mb-6 transition-all duration-500 hover:tracking-[-1.2px]">
            Data Direct – AI-Enhanced Public Health Data Platform
          </h1>
          <p className="text-xl sm:text-2xl lg:text-[28px] font-normal text-[#9FA0A3] leading-[150%] tracking-[-0.28px] max-w-[900px] transition-all duration-300 hover:text-[#131417]">
            Transforming a backend ingestion script into an enterprise-grade public health data platform with AI-driven validation, human-in-the-loop review, and automated reporting.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-[1920px] mx-auto px-4 sm:px-8 lg:px-[100px] pb-24 space-y-24">
            ...
            <div className="flex-1 space-y-6">
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                <div className="bg-white p-6 rounded-[25px] shadow-sm hover:shadow-md transition-all duration-300 hover:scale-[1.02]">
                  ...
                  <p className="text-[18px] font-medium text-[#131417]">SaaS Data Platform</p>
                </div>
                <div className="bg-white p-6 rounded-[25px] shadow-sm hover:shadow-md transition-all duration-300 hover:scale-[1.02]">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mt-8">
                <div className="bg-green-50 p-6 rounded-[25px] border border-green-200 hover:border-green-300 transition-all duration-300 hover:scale-[1.02]">
                  <p className="text-[24px] font-bold text-green-600 mb-2">↓ 40%</p>
                  <p className="text-[16px] font-medium text-[#131417]">User onboarding time</p>
                </div>
                <div className="bg-blue-50 p-6 rounded-[25px] border border-blue-200 hover:border-blue-300 transition-all duration-300 hover:scale-[1.02]">
                  <p className="text-[24px] font-bold text-blue-600 mb-2">↑ 2.6×</p>
                  <p className="text-[16px] font-medium text-[#131417]">Reporting throughput</p>
                </div>
                <div className="bg-purple-50 p-6 rounded-[25px] border border-purple-200 hover:border-purple-300 transition-all duration-300 hover:scale-[1.02]">
                  <p className="text-[24px] font-bold text-purple-600 mb-2">↑ 90%</p>
                  <p className="text-[16px] font-medium text-[#131417]">State-agency adoption</p>
                </div>
              </div>

              <p className="text-[18px] font-normal text-[#131417] leading-[150%] tracking-[-0.18px] mt-6">
                Reimagined Data Direct from a CLI ingestion tool into a web-based public health data platform.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="flex flex-col lg:flex-row gap-8 lg:gap-[200px]">
            ...
            <div className="flex-1 space-y-6">
              <p className="text-[20px] font-normal text-[#131417] leading-[150%] tracking-[-0.2px]">
                Data Direct is a secure SaaS platform for state agencies, clinical submitters, and epidemiologists. Originally a CLI-only toolkit lacking UI, AI checks, and audit logs, the redesign introduced drag-&-drop ingestion, AI-powered schema validation, human-in-the-loop review, and CDC/FHIR-compliant export trails.
              </p>
              <blockquote className="bg-[#131417] text-white p-8 rounded-[25px] italic text-[20px] leading-[150%] tracking-[-0.2px] transition-all duration-300 hover:scale-[1.02]">
                "How might we transform a CLI tool into an intuitive platform that empowers public health teams with AI-assisted data validation?"
              </blockquote>
            </div>
          </div>
        </section>
            ...
            <div className="flex-1 space-y-6">
              <ul className="space-y-3">
                <li className="text-[18px] font-normal text-[#131417] leading-[150%] tracking-[-0.18px] flex items-start gap-3 transition-all duration-300 hover:text-[#2a2a2a]">
                  ...
                  Led end-to-end UX transformation—from research through launch
                </li>
                <li className="text-[18px] font-normal text-[#131417] leading-[150%] tracking-[-0.18px] flex items-start gap-3 transition-all duration-300 hover:text-[#2a2a2a]">
                  <span className="w-2 h-2 bg-[#131417] rounded-full mt-3 flex-shrink-0"></span>
                  Mapped legacy pipelines into modular ingestion-as-a-service workflows
                </li>
                <li className="text-[18px] font-normal text-[#131417] leading-[150%] tracking-[-0.18px] flex items-start gap-3 transition-all duration-300 hover:text-[#2a2a2a]">
                  <span className="w-2 h-2 bg-[#131417] rounded-full mt-3 flex-shrink-0"></span>
                  Designed schema detection UI, validation tables, review-queue panels, and routing dashboards
                </li>
                <li className="text-[18px] font-normal text-[#131417] leading-[150%] tracking-[-0.18px] flex items-start gap-3 transition-all duration-300 hover:text-[#2a2a2a]">
                  <span className="w-2 h-2 bg-[#131417] rounded-full mt-3 flex-shrink-0"></span>
                  Delivered an accessible, HIPAA/FHIR-compliant design system and QA specifications
                </li>
                <li className="text-[18px] font-normal text-[#131417] leading-[150%] tracking-[-0.18px] flex items-start gap-3 transition-all duration-300 hover:text-[#2a2a2a]">
                  <span className="w-2 h-2 bg-[#131417] rounded-full mt-3 flex-shrink-0"></span>
                  Collaborated with policy analysts, engineers, QA, and state-agency liaisons
                </li>
              </ul>
            </div>
          </div>
            ...
            <div className="flex-1 space-y-6">
              <div className="grid grid-cols-1 gap-4">
                <div className="bg-white p-6 rounded-[25px] shadow-sm hover:shadow-md transition-all duration-300 hover:scale-[1.02]">
                  ...
                  <p className="text-[16px] text-[#131417]">Stakeholder interviews, workflow observations, heuristic evaluations, support-ticket audits</p>
                </div>
                <div className="bg-white p-6 rounded-[25px] shadow-sm hover:shadow-md transition-all duration-300 hover:scale-[1.02]">
                  <div className="flex items-center gap-3 mb-3">
                    <span className="text-[24px]">🔍</span>
                  ...
                  <p className="text-[16px] text-[#131417]">Problem framing, persona synthesis, journey mapping, standards mapping (FHIR, HL7, CDC)</p>
                </div>
                <div className="bg-white p-6 rounded-[25px] shadow-sm hover:shadow-md transition-all duration-300 hover:scale-[1.02]">
                  <div className="flex items-center gap-3 mb-3">
                    <span className="text-[24px]">✍</span>
                  ...
                  <p className="text-[16px] text-[#131417]">Smart schema-match modals, inline validation tables with fix suggestions, human-review panels, routing rules editor</p>
                </div>
                <div className="bg-white p-6 rounded-[25px] shadow-sm hover:shadow-md transition-all duration-300 hover:scale-[1.02]">
                  <div className="flex items-center gap-3 mb-3">
                    <span className="text-[24px]">✅</span>
                  ...
                  <p className="text-[16px] text-[#131417]">Pilot testing with analysts and submitters, iterative feedback sessions</p>
                </div>
                <div className="bg-white p-6 rounded-[25px] shadow-sm hover:shadow-md transition-all duration-300 hover:scale-[1.02]">
                  <div className="flex items-center gap-3 mb-3">
                    <span className="text-[24px]">🚀</span>
                  ...
                  <p className="text-[16px] text-[#131417]">Annotated design-system handoff, accessibility audit logs, developer documentation</p>
                </div>
              </div>
            </div>
          </div>
              ...
              <div className="bg-red-50 p-6 rounded-[25px] border border-red-200 transition-all duration-300 hover:border-red-300 hover:scale-[1.02]">
                ...
                <ul className="space-y-2">
                  <li className="text-[18px] font-normal text-[#131417] leading-[150%] tracking-[-0.18px] flex items-start gap-3">
                    ...
                    Opaque errors needed inline tables and clear suggestions
                  </li>
                  <li className="text-[18px] font-normal text-[#131417] leading-[150%] tracking-[-0.18px] flex items-start gap-3">
                    <span className="w-2 h-2 bg-red-500 rounded-full mt-3 flex-shrink-0"></span>
                    Manual schema setup solved with AI-driven schema detection + confidence previews
                  </li>
                  <li className="text-[18px] font-normal text-[#131417] leading-[150%] tracking-[-0.18px] flex items-start gap-3">
                    <span className="w-2 h-2 bg-red-500 rounded-full mt-3 flex-shrink-0"></span>
                    Lack of visibility addressed via real-time job dashboards
                  </li>
                  <li className="text-[18px] font-normal text-[#131417] leading-[150%] tracking-[-0.18px] flex items-start gap-3">
                    <span className="w-2 h-2 bg-red-500 rounded-full mt-3 flex-shrink-0"></span>
                    Compliance burden built CDC/FHIR export templates and downloadable audit logs
                  </li>
                  <li className="text-[18px] font-normal text-[#131417] leading-[150%] tracking-[-0.18px] flex items-start gap-3">
                    <span className="w-2 h-2 bg-red-500 rounded-full mt-3 flex-shrink-0"></span>
                    AI trust ensured through human-in-the-loop controls and explainability
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="flex-1 space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-blue-50 p-6 rounded-[25px] border border-blue-200 transition-all duration-300 hover:border-blue-300 hover:scale-[1.02]">
                  <h3 className="text-[20px] font-medium text-[#131417] mb-4">Julia (Health Data Analyst)</h3>
                  <p className="text-[16px] font-normal text-[#131417] leading-[150%] tracking-[-0.16px] mb-3">
                    <strong>Goals:</strong> Validate data quickly, reduce IT dependency, ensure audit readiness
                  </p>
                  <p className="text-[16px] font-normal text-[#131417] leading-[150%] tracking-[-0.16px]">
                    <strong>Needs:</strong> Role-based dashboards, AI-assisted fixes, clear error feedback
                  </p>
                </div>
                <div className="bg-green-50 p-6 rounded-[25px] border border-green-200 transition-all duration-300 hover:border-green-300 hover:scale-[1.02]">
                  <h3 className="text-[20px] font-medium text-[#131417] mb-4">Oscar (Clinic Admin / Submitter)</h3>
                  <p className="text-[16px] font-normal text-[#131417] leading-[150%] tracking-[-0.16px] mb-3">
                    <strong>Goals:</strong> Submit clean files with minimal rework
                  </p>
                  <p className="text-[16px] font-normal text-[#131417] leading-[150%] tracking-[-0.16px]">
                    <strong>Needs:</strong> Real-time schema match confirmation, field-level error previews, resubmission insights
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="flex-1 space-y-6">
              <ul className="space-y-4">
                <li className="text-[18px] font-normal text-[#131417] leading-[150%] tracking-[-0.18px] flex items-start gap-3 transition-all duration-300 hover:text-[#2a2a2a]">
                  ...
                  <div>
                    <strong>Smart Schema Detection:</strong> AI-powered match with preview & override
                  </div>
                </li>
                <li className="text-[18px] font-normal text-[#131417] leading-[150%] tracking-[-0.18px] flex items-start gap-3 transition-all duration-300 hover:text-[#2a2a2a]">
                  <span className="text-green-600 text-[20px] mt-1">✅</span>
                  <div>
                    <strong>Anomaly Detection:</strong> Severity-graded flags + rationale tooltips
                  </div>
                </li>
                <li className="text-[18px] font-normal text-[#131417] leading-[150%] tracking-[-0.18px] flex items-start gap-3 transition-all duration-300 hover:text-[#2a2a2a]">
                  <span className="text-green-600 text-[20px] mt-1">✅</span>
                  <div>
                    <strong>Auto-Suggested Fixes:</strong> Inline accept/reject + bulk apply high-confidence fixes
                  </div>
                </li>
                <li className="text-[18px] font-normal text-[#131417] leading-[150%] tracking-[-0.18px] flex items-start gap-3 transition-all duration-300 hover:text-[#2a2a2a]">
                  <span className="text-green-600 text-[20px] mt-1">✅</span>
                  <div>
                    <strong>Human-in-the-Loop Review:</strong> Batch panel with comments, fix history, rollback
                  </div>
                </li>
                <li className="text-[18px] font-normal text-[#131417] leading-[150%] tracking-[-0.18px] flex items-start gap-3 transition-all duration-300 hover:text-[#2a2a2a]">
                  <span className="text-green-600 text-[20px] mt-1">✅</span>
                  <div>
                    <strong>Predictive Routing:</strong> Configurable auto-routing to CDC, SFTP, API endpoints
                  </div>
                </li>
                <li className="text-[18px] font-normal text-[#131417] leading-[150%] tracking-[-0.18px] flex items-start gap-3 transition-all duration-300 hover:text-[#2a2a2a]">
                  <span className="text-green-600 text-[20px] mt-1">✅</span>
                  <div>
                    <strong>Audit-Ready Reporting:</strong> Downloadable CDC/FHIR exports & comprehensive logs
                  </div>
                </li>
                <li className="text-[18px] font-normal text-[#131417] leading-[150%] tracking-[-0.18px] flex items-start gap-3 transition-all duration-300 hover:text-[#2a2a2a]">
                  <span className="text-green-600 text-[20px] mt-1">✅</span>
                  <div>
                    <strong>Role-Based Dashboards:</strong> Custom filters & views per persona
                  </div>
                </li>
              </ul>
            </div>
                ...
                <table className="w-full min-w-[500px]">
                  ...
                  <tbody>
                    <tr className="border-b border-gray-100 hover:bg-gray-50 transition-colors duration-300">
                      <td className="py-4 px-4 text-[16px] text-[#131417]">AI-Powered Schema Detection</td>
                      <td className="py-4 px-4 text-green-600 text-[18px]">✅</td>
                      <td className="py-4 px-4 text-red-500 text-[18px]">❌</td>
                    </tr>
                    <tr className="border-b border-gray-100 hover:bg-gray-50 transition-colors duration-300">
                      <td className="py-4 px-4 text-[16px] text-[#131417]">Inline Validation & Fixes</td>
                      <td className="py-4 px-4 text-green-600 text-[18px]">✅</td>
                      <td className="py-4 px-4 text-yellow-500 text-[18px]">⚠️</td>
                    </tr>
                    <tr className="border-b border-gray-100 hover:bg-gray-50 transition-colors duration-300">
                      <td className="py-4 px-4 text-[16px] text-[#131417]">Human-in-the-Loop Review</td>
                      <td className="py-4 px-4 text-green-600 text-[18px]">✅</td>
                      <td className="py-4 px-4 text-yellow-500 text-[18px]">⚠️</td>
                    </tr>
                    <tr className="border-b border-gray-100 hover:bg-gray-50 transition-colors duration-300">
                      <td className="py-4 px-4 text-[16px] text-[#131417]">Predictive Routing</td>
                      <td className="py-4 px-4 text-green-600 text-[18px]">✅</td>
                      <td className="py-4 px-4 text-red-500 text-[18px]">❌</td>
                    </tr>
                    <tr className="border-b border-gray-100 hover:bg-gray-50 transition-colors duration-300">
                      <td className="py-4 px-4 text-[16px] text-[#131417]">CDC/FHIR Export Templates</td>
                      <td className="py-4 px-4 text-green-600 text-[18px]">✅</td>
                      <td className="py-4 px-4 text-yellow-500 text-[18px]">⚠️</td>
                    </tr>
            ...
            <div className="flex-1 space-y-8">
                ...
                <table className="w-full min-w-[400px]">
                  ...
                  <tbody>
                    <tr className="border-b border-gray-100 hover:bg-gray-50 transition-colors duration-300">
                      ...
                      <td className="py-4 px-4 text-[16px] font-medium text-green-600">↓ 70% (3-5 days → 24 hrs)</td>
                    </tr>
                    <tr className="border-b border-gray-100 hover:bg-gray-50 transition-colors duration-300">
                      <td className="py-4 px-4 text-[16px] text-[#131417]">Analyst Correction Time</td>
                      <td className="py-4 px-4 text-[16px] font-medium text-blue-600">↓ 67% (6.3 hrs → 2.1 hrs/dataset)</td>
                    </tr>
                    <tr className="border-b border-gray-100 hover:bg-gray-50 transition-colors duration-300">
                      <td className="py-4 px-4 text-[16px] text-[#131417]">Dev-Dependent Pipelines</td>
                      <td className="py-4 px-4 text-[16px] font-medium text-purple-600">↓ 85% (100% → 15%)</td>
                    </tr>
                    <tr className="border-b border-gray-100 hover:bg-gray-50 transition-colors duration-300">
                      <td className="py-4 px-4 text-[16px] text-[#131417]">Monthly Reporting Errors</td>
                      <td className="py-4 px-4 text-[16px] font-medium text-orange-600">↓ 83% (30 → 5)</td>
                    </tr>
                    <tr className="hover:bg-gray-50 transition-colors duration-300">
                      <td className="py-4 px-4 text-[16px] text-[#131417]">Pilot Agency Adoption</td>
                      <td className="py-4 px-4 text-[16px] font-medium text-indigo-600">↑ 130% (3 → 7 states)</td>
                    </tr>
                  </tbody>
                </table>
              </div>
              ...
              <div className="space-y-4">
                <blockquote className="bg-green-50 border-l-4 border-green-500 p-6 rounded-r-[25px] italic text-[18px] leading-[150%] tracking-[-0.18px] transition-all duration-300 hover:scale-[1.02]">
                  "The AI suggestions are spot-on and save us hours of manual validation work." — Health Data Analyst
                </blockquote>
                <blockquote className="bg-blue-50 border-l-4 border-blue-500 p-6 rounded-r-[25px] italic text-[18px] leading-[150%] tracking-[-0.18px] transition-all duration-300 hover:scale-[1.02]">
                  "Finally, a platform that understands our compliance needs and makes reporting effortless." — State Epidemiologist
                </blockquote>
              </div>
            </div>
          </div>
        ...
        <section className="animate-in fade-in-0 slide-in-from-bottom-8 duration-1000 delay-2500">
          <div className="flex flex-col lg:flex-row gap-8 lg:gap-[200px]">
            ...
            <div className="flex-1 space-y-6">
              <blockquote className="bg-[#131417] text-white p-8 rounded-[25px] italic text-[20px] leading-[150%] tracking-[-0.2px] transition-all duration-300 hover:scale-[1.02]">
                "Thoughtful UX, automation, and AI can transform public health systems—empowering analysts with intuitive workflows and decision support."
              </blockquote>
              ...
              <div className="bg-gray-50 p-6 rounded-[25px] mt-8 transition-all duration-300 hover:bg-gray-100">
                ...
                <ul className="space-y-2">
                  <li className="text-[16px] font-normal text-[#131417] leading-[150%] tracking-[-0.16px] flex items-start gap-3">
                    ...
                    AI transparency builds trust in data validation workflows
                  </li>
                  <li className="text-[16px] font-normal text-[#131417] leading-[150%] tracking-[-0.16px] flex items-start gap-3">
                    <span className="w-1.5 h-1.5 bg-[#9FA0A3] rounded-full mt-2.5 flex-shrink-0"></span>
                    Human-in-the-loop design ensures compliance and accuracy
                  </li>
                  <li className="text-[16px] font-normal text-[#131417] leading-[150%] tracking-[-0.16px] flex items-start gap-3">
                    <span className="w-1.5 h-1.5 bg-[#9FA0A3] rounded-full mt-2.5 flex-shrink-0"></span>
                    Role-based interfaces improve adoption across diverse user types
                  </li>
                </ul>
              </div>
            </div>
