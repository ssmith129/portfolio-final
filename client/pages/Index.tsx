...
export default function Index() {
  ...
  const openModal = (imageSrc: string, imageTitle: string, e: React.MouseEvent) => {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 md:gap-10 lg:gap-12 xl:gap-16 animate-in fade-in-0 slide-in-from-bottom-8 duration-1000 delay-700">
          ...
          >
            <div className="aspect-square overflow-hidden relative">
              ...
              {/* Rule Builder Preview Overlay */}
              <div className="absolute top-4 right-4 bg-white/90 backdrop-blur-sm rounded-lg p-2 opacity-0 group-hover:opacity-100 transition-all duration-300">
                <button
                  onClick={(e) => openModal("/Rule Builder.png", "Rule Builder Interface")}
                  className="flex items-center gap-2 text-xs font-medium text-[#131417] hover:text-blue-600 transition-colors"
                  aria-label="View Rule Builder interface in detail"
                >
      ...
      {isModalOpen && selectedImage && (
        ...
        >
          <div className="relative max-w-[95vw] max-h-[95vh] animate-in zoom-in-95 duration-300">
            ...
            {/* Modal Title */}
            <h2 id="modal-title" className="absolute -top-12 left-0 text-white text-lg font-medium">
              {selectedImage.title}
            </h2>
            ...
            <img
              ...
              onError={() => console.error('Failed to load image:', selectedImage.src)}
            />
