    ...
    <div className="min-h-screen bg-[#F5F5F5]">
      ...
      <div className="max-w-[1920px] mx-auto px-4 sm:px-8 lg:px-[100px] pt-16 pb-24 animate-in fade-in-0 slide-in-from-bottom-8 duration-1000 delay-500">
        <div className="mb-8">
          ...
          <p className="text-[18px] font-normal text-[#9FA0A3] leading-[160%] tracking-[-0.18px] max-w-[600px]">
            A comprehensive case study exploring the design and development of a sophisticated crypto tax calculation engine.
          </p>
        </div>
      </div>
            ...
            <div className="flex-1 space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <div className="bg-white p-6 rounded-[20px] shadow-sm hover:shadow-md transition-all duration-300 cursor-pointer hover:scale-[1.02] group">
                  ...
                  <div className="relative aspect-video overflow-hidden rounded-lg cursor-pointer group-hover:scale-[1.02] transition-transform duration-300"
                       onClick={() => openModal('/Transactions Grid.png', 'Transaction Processing', 'Comprehensive Grid View')}>
                    {/* Main Image */}
                    <img
                      src="/Transactions Grid.png"
                      alt="Transactions Grid - Comprehensive Grid View showing transaction processing interface"
                    ...
                    <div className="absolute inset-0 bg-gradient-to-br from-blue-50 to-purple-50 flex items-center justify-center" style={{ display: 'none' }}>
                      <div className="text-center text-gray-400">
                        ...
                        <span className="text-sm font-medium">Transactions Grid</span>
                      </div>
                    </div>
                    ...
                    <div className="absolute inset-0 bg-black/40 backdrop-blur-[1px] flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-300">
                      <div className="text-center text-white transform scale-90 group-hover:scale-100 transition-transform duration-300">
                        <div className="w-10 h-10 mx-auto mb-3 bg-white/20 rounded-full flex items-center justify-center backdrop-blur-sm">
                          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0zM10 7v3m0 0v3m0-3h3m-3 0H7" />
                          </svg>
                        </div>
                        <span className="text-sm font-semibold tracking-wide">Click to enlarge</span>
                        <div className="text-xs opacity-75 mt-1">View full-size image</div>
                      </div>
                    </div>
                    
                    {/* Loading State */}
                    <div className="absolute inset-0 bg-gradient-to-br from-blue-50 to-purple-50 flex items-center justify-center opacity-0 group-hover:opacity-0 transition-opacity duration-300">
                      <div className="animate-pulse text-center text-gray-400">
                        <div className="w-8 h-8 mx-auto mb-2 bg-gray-300 rounded-full animate-pulse"></div>
      ...
      {selectedImage && (
        ...
        >
          <div className="relative max-w-[90vw] max-h-[90vh]">
            ...
            <button
              onClick={closeModal}
              className="absolute top-4 right-4 text-white text-2xl bg-black bg-opacity-50 rounded-full w-10 h-10 flex items-center justify-center hover:bg-opacity-75 transition-all duration-200"
            >
              ×
            </button>
